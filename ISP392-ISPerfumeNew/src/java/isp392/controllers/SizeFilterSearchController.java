 ...
 * @author ThinhHoang
 */
public class SizeFilterSearchController extends HttpServlet {

    private static final String ERROR = "shoppingSearch.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ViewProductDTO> listProduct = productDAO.fiterSearchResult(search, sizeList);
            session.setAttribute("LIST_PRODUCT_SEARCH", listProduct);
            int listSize = listProduct.size();
            session.setAttribute("SEARCH_RESULT_SIZE", listSize);
            url = SUCCESS;
        } catch (Exception e) {
            log("Error at SizeFilterSearchController: " + e.toString());
        } finally {
