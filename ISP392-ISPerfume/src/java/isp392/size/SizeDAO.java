...
public class SizeDAO {
    ...
    private final String GET_AVAILABLE_SIZE = "SELECT S.SizeID, S.Name FROM Size S "
    ...
    public List<SizeDTO> getAvailableSize(int productID) throws ClassNotFoundException, SQLException {
        List<SizeDTO> listSize = new ArrayList<>();
        Connection conn = null;
        PreparedStatement ptm = null;
        ResultSet rs = null;
