...
public final class cart_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                    Product\r\n");
      out.write("                                    Name</td>\r\n");
      out.write("                                <td class=\"align-middle price\">$12</td>\r\n");
      ...
      out.write("                                    </div>\r\n");
      out.write("                                </td>\r\n");
      out.write("                                <td class=\"align-middle total\">$12</td>\r\n");
      out.write("                                <td class=\"align-middle\"><button class=\"btn btn-sm btn-danger\"><i\r\n");
      out.write("                                            class=\"fa fa-times\"></i></button></td>\r\n");
      out.write("                            </tr>\r\n");
      out.write("                            <tr>\r\n");
      out.write("                                <td class=\"align-middle\"><img src=\"img/product-2.jpg\" alt=\"\" style=\"width: 50px;\">\r\n");
      out.write("                                    Product\r\n");
      out.write("                                    Name</td>\r\n");
      out.write("                                <td class=\"align-middle price\">$40</td>\r\n");
      out.write("                                <td class=\"align-middle\">\r\n");
      out.write("                                    <div class=\"input-group quantity mx-auto\" style=\"width: 100px;\">\r\n");
      out.write("                                        <div class=\"input-group-btn\">\r\n");
      out.write("                                            <button class=\"btn btn-sm btn-primary btn-minus\">\r\n");
      ...
      out.write("                                    </div>\r\n");
      out.write("                                </td>\r\n");
      out.write("                                <td class=\"align-middle total\">$40</td>\r\n");
      out.write("                                <td class=\"align-middle\"><button class=\"btn btn-sm btn-danger\"><i\r\n");
      out.write("                                            class=\"fa fa-times\"></i></button></td>\r\n");
      out.write("                            </tr>\r\n");
      out.write("                            <tr>\r\n");
      out.write("                                <td class=\"align-middle\"><img src=\"img/product-3.jpg\" alt=\"\" style=\"width: 50px;\">\r\n");
      out.write("                                    Product\r\n");
      out.write("                                    Name</td>\r\n");
      out.write("                                <td class=\"align-middle price\">$30</td>\r\n");
      out.write("                                <td class=\"align-middle\">\r\n");
      out.write("                                    <div class=\"input-group quantity mx-auto\" style=\"width: 100px;\">\r\n");
      out.write("                                        <div class=\"input-group-btn\">\r\n");
      out.write("                                            <button class=\"btn btn-sm btn-primary btn-minus\">\r\n");
      ...
      out.write("                                    </div>\r\n");
      out.write("                                </td>\r\n");
      out.write("                                <td class=\"align-middle total\">$30</td>\r\n");
      out.write("                                <td class=\"align-middle\"><button class=\"btn btn-sm btn-danger\"><i\r\n");
      out.write("                                            class=\"fa fa-times\"></i></button></td>\r\n");
      out.write("                            </tr>\r\n");
      out.write("                        </tbody>\r\n");
      ...
      out.write("                                <h5 id=\"total-cart\">$160</h5> \r\n");
      out.write("                            </div>\r\n");
      ...
      out.write("                const shippingCost = 10; // Giá vận chuyển cố định\r\n");
      out.write("                let subtotalElement = document.getElementById('subtotal');\r\n");
      out.write("                let totalCartElement = document.getElementById('total-cart');\r\n");
      out.write("\r\n");
      out.write("                console.log(subtotalElement);  // Kiểm tra phần tử subtotal\r\n");
      out.write("                console.log(totalCartElement);\r\n");
      out.write("                // Hàm tính tổng giỏ hàng và cập nhật subtotal, total\r\n");
      out.write("                function updateCartTotals() {\r\n");
      out.write("                    let subtotal = 0;\r\n");
      out.write("                    // Duyệt qua tất cả các hàng sản phẩm để tính tổng\r\n");
      out.write("                    document.querySelectorAll('tr').forEach(function (row) {\r\n");
      out.write("                        const totalElement = row.querySelector('.total');\r\n");
      out.write("                        if (totalElement) {\r\n");
      out.write("                            // Chuyển đổi chuỗi '$xxx' thành số\r\n");
      out.write("                            let total = parseFloat(totalElement.innerText.replace('$', '')) || 0;\r\n");
      out.write("                            subtotal += total; // Cộng dồn vào subtotal\r\n");
      out.write("                        }\r\n");
      out.write("                    });\r\n");
      out.write("\r\n");
      out.write("                    // Kiểm tra và cập nhật Subtotal\r\n");
      out.write("\r\n");
      out.write("                    if (subtotalElement) {\r\n");
      out.write("                        subtotalElement.innerText = `$");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${subtotal.toFixed()}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("`; // Cập nhật giá trị hiển thị với 2 chữ số thập phân\r\n");
      out.write("                    }\r\n");
      out.write("\r\n");
      out.write("                    // Kiểm tra và cập nhật Total (Subtotal + Shipping)\r\n");
      out.write("\r\n");
      out.write("                    if (totalCartElement) {\r\n");
      out.write("                        let total = subtotal + shippingCost;\r\n");
      out.write("                        totalCartElement.innerText = `$");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${total.toFixed(0)}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("`; // Cập nhật giá trị hiển thị với 2 chữ số thập phân\r\n");
      out.write("                    }\r\n");
      out.write("                }\r\n");
      out.write("\r\n");
      out.write("                // Event delegation cho nút tăng/giảm số lượng và xóa\r\n");
      out.write("                document.body.addEventListener('click', function (e) {\r\n");
      out.write("                    if (e.target.closest('.btn-plus') || e.target.closest('.btn-minus')) {\r\n");
      out.write("                        e.preventDefault(); // Ngăn form bị gửi đi\r\n");
      out.write("\r\n");
      ...
      out.write("                        const totalElement = row.querySelector('.total');\r\n");
      out.write("                        let price = parseFloat(priceElement.innerText.replace('$', '')) || 0;\r\n");
      out.write("                        let quantity = parseInt(quantityInput.value);\r\n");
      out.write("                        // Tăng/giảm số lượng\r\n");
      out.write("                        if (e.target.closest('.btn-plus')) {\r\n");
      out.write("                            quantity++;\r\n");
      out.write("                        } else if (e.target.closest('.btn-minus') && quantity > 1) {\r\n");
      out.write("                            quantity--;\r\n");
      out.write("                        }\r\n");
      out.write("\r\n");
      out.write("                        quantityInput.value = quantity; // Cập nhật số lượng\r\n");
      out.write("                        let total = price * quantity; // Tính toán tổng tiền của sản phẩm\r\n");
      out.write("                        totalElement.innerText = `$");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${total.toFixed()}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("`; // Cập nhật lại total với định dạng 2 chữ số thập phân\r\n");
      out.write("\r\n");
      out.write("                        // Thêm log để kiểm tra phần tử trước khi tính toán\r\n");
      out.write("                        console.log(subtotalElement);  // Kiểm tra phần tử subtotal\r\n");
      out.write("                        console.log(totalCartElement); // Kiểm tra phần tử total cart\r\n");
      out.write("                        console.log(totalElement); // Kiểm tra phần tử total cart\r\n");
      out.write("\r\n");
      out.write("                        // Cập nhật lại tổng số tiền của giỏ hàng\r\n");
      out.write("                        updateCartTotals();\r\n");
      out.write("                    }\r\n");
      out.write("\r\n");
      out.write("                    // Xử lý xóa sản phẩm\r\n");
      out.write("                    if (e.target.closest('.btn-danger')) {\r\n");
      out.write("                        e.preventDefault(); // Ngăn form bị gửi đi\r\n");
      out.write("\r\n");
      out.write("                        const row = e.target.closest('tr');\r\n");
      out.write("                        if (row) {\r\n");
      out.write("                            row.remove(); // Xóa dòng sản phẩm\r\n");
      out.write("                        }\r\n");
      out.write("\r\n");
      out.write("                        updateCartTotals(); // Cập nhật lại tổng số tiền\r\n");
      out.write("                    }\r\n");
      out.write("                });\r\n");
      out.write("\r\n");
      out.write("                // Gọi hàm updateCartTotals khi tải trang để cập nhật subtotal và total-cart ngay từ đầu\r\n");
      out.write("                updateCartTotals();\r\n");
      out.write("            });\r\n");
      out.write("        </script>\r\n");
      out.write("    </body>\r\n");
