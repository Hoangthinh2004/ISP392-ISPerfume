...
public final class orderStatus_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <link href=\"css/styleOrderStatus.css\" rel=\"stylesheet\">\r\n");
      out.write("        <style>\r\n");
      ...
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            /* Highlight for current step */\r\n");
      ...
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            /* Highlight completed steps */\r\n");
      out.write("            .step-wizard-item.completed .progress-count:before {\r\n");
      out.write("                display: block;\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            .step-wizard-item.completed .progress-count:after {\r\n");
      out.write("                background: #FE980F;\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            .step-wizard-item.completed + .step-wizard-item:after {\r\n");
      out.write("                background: #FE980F;\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            /* Dim future steps */\r\n");
      out.write("            .step-wizard-item:not(.completed) + .step-wizard-item:after {\r\n");
      ...
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            .step-wizard-item.completed {\r\n");
      out.write("                opacity: 1;\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            .progress-background {\r\n");
      out.write("                position: absolute;\r\n");
      out.write("                top: 22px;\r\n");
      out.write("                left: 0;\r\n");
      out.write("                width: 100%;\r\n");
      out.write("                height: 2px;\r\n");
      out.write("                background-color: #e0e0e0; /* Màu nền của thanh tiến trình */\r\n");
      out.write("                z-index: 1; /* Đặt phía sau các step */\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      ...
      out.write("                left: 0;\r\n");
      out.write("                height: 2px;\r\n");
      out.write("                background-color: #FE980F; /* Màu của thanh tiến trình */\r\n");
      out.write("                width: 0%; /* Bắt đầu từ 0% */\r\n");
      out.write("                z-index: 2; /* Đặt phía trước nền */\r\n");
      out.write("                transition: width 0.4s ease; /* Hiệu ứng mượt mà khi chạy */\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            .step-wizard-item {\r\n");
      out.write("                position: relative;\r\n");
      out.write("                z-index: 3; /* Đặt trên cùng để không bị che bởi thanh tiến trình */\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("        </style>\r\n");
      out.write("\r\n");
      ...
      out.write("            <div class=\"progress-background\">\r\n");
      out.write("                <div class=\"progress-fill\"></div> <!-- Đây là thanh tiến trình chạy -->\r\n");
      out.write("            </div>\r\n");
      out.write("            <ul class=\"step-wizard-list\">\r\n");
      out.write("                <li class=\"step-wizard-item completed\">\r\n");
      ...
      out.write("                const progressFill = document.querySelector(\".progress-fill\");\r\n");
      out.write("                const steps = document.querySelectorAll(\".step-wizard-item\");\r\n");
      out.write("                const currentStepIndex = Array.from(steps).findIndex(step => step.classList.contains(\"current-item\"));\r\n");
      out.write("                const totalSteps = steps.length;\r\n");
      out.write("\r\n");
      out.write("                // Tính phần trăm tiến trình dựa trên vị trí của mục hiện tại\r\n");
      out.write("                const progressPercentage = ((currentStepIndex + 1) / totalSteps) * 100;\r\n");
      out.write("\r\n");
      out.write("                // Đảm bảo progressFill bắt đầu từ 0%\r\n");
      out.write("                progressFill.style.width = '0%';\r\n");
      out.write("\r\n");
      out.write("                // Tạo hiệu ứng từ từ chạy từ 0 đến giá trị progressPercentage\r\n");
      out.write("                let progress = 0;\r\n");
      out.write("                const interval = setInterval(function () {\r\n");
      out.write("                    if (progress < progressPercentage) {\r\n");
      out.write("                        progress += 1; // Tăng giá trị width\r\n");
      out.write("                        progressFill.style.width = progress + \"%\"; // Cập nhật width\r\n");
      out.write("                    } else {\r\n");
      out.write("                        clearInterval(interval); // Dừng lại khi đạt đến giá trị cần thiết\r\n");
      out.write("                    }\r\n");
      out.write("                }, 20); // Điều chỉnh tốc độ bằng cách thay đổi thời gian delay (20ms mỗi lần)\r\n");
      out.write("            });\r\n");
      out.write("\r\n");
      out.write("        </script>\r\n");
      out.write("\r\n");
